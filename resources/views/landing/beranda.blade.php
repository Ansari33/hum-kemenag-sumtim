									...
									<div id="kt_sliders_widget_2_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100 bgi-no-repeat bgi-size-cover bgi-position-y-center" data-bs-ride="carousel" data-bs-interval="5500" style="background-image:url('https://scontent.fsub2-3.fna.fbcdn.net/v/t51.82787-15/639501962_18139683835489219_6452314199145012551_n.webp?stp=dst-jpg_tt6&_nc_cat=110&ccb=1-7&_nc_sid=13d280&_nc_ohc=W0wYo9yC_hQQ7kNvwGnAEmC&_nc_oc=Adr4FKnz8mZDHrYdi5m1gdShKKrZ4bYWQ8SKEB3_z1eZXM5OOg3c7puGMA8Q4ToCuvk&_nc_zt=23&_nc_ht=scontent.fsub2-3.fna&_nc_gid=dM6dQZwvH7BsYhJThP-W6w&_nc_ss=7b289&oh=00_Af3wPV53pu8JOQ2c6B481C0WOcuNfe7mV98IR7BVu2NknA&oe=69F90F3F')">
										...
										<div class="card-header pt-5">
											...
											<div class="text-center">
												<span class="card-label fw-bold text-gray-800 text-center"></span>
											</div>
							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xl-6">
									...
									<div class="card card-xl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Data Umat Beragama 2026</span>
												<span class="text-muted mt-1 fw-semibold fs-7">Per Kecamatan</span>
											</h3>
											<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" >
												<a href="/informasi/data-keagamaan" class="btn btn-sm btn-light btn-active-primary" >
												<i class="ki-duotone ki-plane fs-2"></i>Selengkapnya</a>
											</div>
										</div>
										<!--end::Header-->
										<!--begin::Body-->
												...
												<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
													...
													<thead>
														<tr class="fw-bold text-muted">
															...
															<th class="min-w-150px">Kriten</th>
													...
													<tbody>
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Kota Waingapu</a>
																	</div>
																</div>
															</td>
															<td>
																<div class="d-flex flex-stack mb-2">
																		<span class="text-primary me-2 fs-7 fw-bold">119215</span>
																	</div>
															</td>
															<td class="text-end">
																<div class="text-success d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																		<span class=" me-2 fs-7 fw-bold">18457</span>
																	</div>
															...
															<td>
																<div class="d-flex flex-stack mb-2">
																		<span class=" text-info me-2 fs-7 fw-bold">5127</span>
																	</div>
															</td>
															<td>
																<div class="d-flex flex-stack mb-2">
																		<span class="text-warning me-2 fs-7 fw-bold">227</span>
																	</div>
															</td>
															<td>
																<div class="d-flex flex-stack mb-2">
																		<span class=" text-danger me-2 fs-7 fw-bold">14</span>
																	</div>
															</td>
															<td>
																<div class="d-flex flex-stack mb-2">
																		<span class=" me-2 fs-7 fw-bold">0</span>
																	</div>
															</td>
															<td>
																<div class="d-flex flex-stack mb-2">
																		<span class=" text-muted me-2 fs-7 fw-bold">1695</span>
																	</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Haharu</a>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Lewa</a>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Nggaha Ori Angu</a>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Tabundung</a>
																	</div>
																</div>
															</td>
															<td>
								...
								<div class="col-xl-6">
									...
									<div class="card card-xl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Data Pendidikan 2026</span>
												<span class="text-muted mt-1 fw-semibold fs-7">Per Kecamatan</span>
											</h3>
											<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" >
												<a href="/informasi/data-pendidikan" class="btn btn-sm btn-light btn-active-primary" >
												<i class="ki-duotone ki-plane fs-2"></i>Selengkapnya</a>
											</div>
										</div>
										<!--end::Header-->
												...
												<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
													...
													<thead>
														<tr class="fw-bold text-muted">
															...
															<th class="min-w-150px">Jumlah Siswa</th>
															<th class="min-w-150px">Jumlah Guru</th>
															<th class="min-w-200px">Jumlah Guru Agama</th>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Raudatul Athfal</a>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Madrasah Ibtidaiyah</a>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">Madrasah Tsanawiyah</a>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">SMPTK</a>
																	</div>
																</div>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-dark fw-bold text-hover-primary fs-6">SMATK</a>
																	</div>
																</div>
															</td>
															<td>
