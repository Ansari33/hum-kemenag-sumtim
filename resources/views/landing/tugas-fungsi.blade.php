									...
									<div class="card ">
										...
										<div class="card-header pt-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-dark">Tugas dan Fungsi</span>
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
										...
										<div class="card-body pt-6">
											...
											<div class="text-center mb-18">
												<!--begin::Title-->
												<h3 class="fs-2hx text-dark mb-6">Tugas</h3>
												<!--end::Title-->
												<!--begin::Text-->
												<div class="fs-5 text-gray-800 fw-semibold">Kantor Kementerian Agama kabupaten/kota bertugas melaksanakan tugas dan
fungsi Kementerian Agama di wilayah Kabupaten/Kota berdasarkan kebijakan
Kepala Kantor Wilayah Kementerian Agama ketentuan dan ketentuan peraturan-undangan.
											    </div>
												<!--end::Text-->
											</div>
											<!--end::Top-->
											...
											<div class="text-center mb-10">
												<!--begin::Title-->
												<h3 class="fs-2hx text-dark mb-3">Fungsi</h3>
												<!--end::Title-->
														...
														<table class="table align-middle gs-0 gy-4">
															...
															<tbody>
																<tr>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Perumusan dan penetapan visi, misi, dan kebijakan teknis di bidang pelayanan
dan bimbingan kehidupan beragama kepada masyarakat di kabupaten/kota;
                                                                ...
                                                                <tr>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Pelayanan, bimbingan, dan pelatihan kehidupan beragama;
</a>
                                                                ...
                                                                <tr>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Pelayanan, bimbingan, dan pelatihan haji dan umrah, serta zakat dan wakaf;</a>
																	</td>
																</tr>
                                                                <tr>
																	<td>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Pelayanan, bimbingan, dan pelatihan di bidang pendidikan madrasah,
pendidikan agama, dan pendidikan keagamaan;</a>
																	</td>
																</tr>
                                                                <tr>
																	<td>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Pembinaan kerukunan umat beragama;
</a>
																	</td>
																</tr>
                                                                <tr>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">pelaksanaan kebijakan teknis di bidang administrasi dan informasi;
</a>
																	</td>
																</tr>
                                                                <tr>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Pengoordinasian perencanaan, pengendalian, pengawasan, dan evaluasi
program; dan
</a>
																	</td>
																</tr>
                                                                <tr>
																	...
																	<td>
																		<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Pelaksanaan hubungan dengan pemerintah daerah, instansi terkait, dan
											...
											<div class="m-0">
												...
												<ul class="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
													...
													<li class="nav-item mt-5">
														<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="sejarah.html">
													...
													<!--begin::Nav item-->
													<li class="nav-item mt-5">
														<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="visi-misi.html">
													...
													<!--begin::Nav item-->
													<li class="nav-item mt-5">
														<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 active" href="tugas-fungsi.html">
