    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-lg-1 mt-5">
          <a class="btn btn-primary ml-4" href="{{ route('konten.add') }}" wire:navigate>{{ __('Baru') }}</a>
        </div>
      </div>
      <div class="m-2">
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="/publikasi/konten/edit/{{$p->id}}" wire:navigate
