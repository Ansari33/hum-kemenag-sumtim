@section('title', __('Data Rumah Ibadah'))
<div>
    <div class="card">
      <div class="row">
        <div class="col-lg-8">
          <h5 class="card-header">Data Rumah Ibadah</h5>
        </div>
        ...
        <div class="col-lg-1 mt-5">
          <a class="btn btn-primary ml-4" href="{{ route('rumah-ibadah.add') }}" wire:navigate>{{ __('Baru') }}</a>
        </div>
      </div>
      <div class="m-2">
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="/data/rumah-ibadah/edit/{{$p->id}}" wire:navigate
