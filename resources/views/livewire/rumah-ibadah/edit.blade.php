@section('title', __('Edit Rumah Ibadah'))
<div>
    <div class="card mb-1">
        <h5 class="card-header">Edit Data Rumah Ibadah</h5>
    </div>
    <div class="card p-4">  
      <form wire:submit.prevent="update">
        ...
        <div class="mb-4 row">
          <label for="html5-email-input" class="col-md-2 col-form-label">Vihara</label>
          <div class="col-md-10">
